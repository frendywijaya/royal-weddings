    ...
    <div class="content">
        <div class="card">
            <div class="card-header d-flex align-items-center py-0">
                <h5 class="mb-0 py-3">Gallery Management</h5>
                <div class="my-auto ms-auto">
                </div>
                <div class="my-auto ms-auto">
                    <button type="button" class="btn btn-primary btn-create" data-url="{{route('admin.gallery.store')}}" data-bs-toggle="modal" data-bs-target="#modal_form">
                    ...
                    <div class="card mt-3 mb-3">
                        <div class="card-img-actions mx-1 mt-1">
                            <a href="#course_preview" class="d-inline-block position-relative" data-bs-toggle="modal">
                                <img src="{{ asset($path.$gallery->image) }}" class="img-fluid card-img"
                                    alt="">
                            </a>
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a href="#" class="btn-edit" data-bs-toggle="modal"
                                    data-bs-target="#modal_form" data-url="{{route('admin.gallery.update' , $gallery->id)}}" data-item="{{json_encode($gallery)}}">Edit</a></li>
                                <li class="list-inline-item"><a href="#" data-bs-toggle="modal" class="btn-delete"
                                        data-bs-target="#modal_delete" data-url="{{route('admin.gallery.destroy' , $gallery->id)}}">Delete</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /simple thumbnail with image -->
                    ...
                    <div class="modal-body">
                        <div class="row mb-3 mt-2 pb-3 border-bottom">
                            <div class="col-lg-12 justify-content-center">
                                <p class="fw-semibold">Gallery Image</p>
