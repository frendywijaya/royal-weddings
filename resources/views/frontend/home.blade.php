...
<section class="banner-section banner-section__home-two">
    <div class="banner-carousel thm__owl-carousel owl-theme owl-carousel" data-options='{"loop": true, "items": 1, "margin": 0, "dots": false, "nav": true, "animateOut": "fadeOut", "animateIn": "fadeIn", "active": true, "smartSpeed": 1000, "autoplay": true, "autoplayTimeout": 6000, "autoplayHoverPause": false}'>
        ...
        <!-- Slide Item -->
        <div class="slide-item">
            <div class="image-layer lazy-image" style="background-image: url('{{ asset('frontend/images/main-slider/banner-2-2.jpg') }}');"></div>
            <div class="container">
                <div class="content-box text-center">
        ...
        <!-- Slide Item -->
        <div class="slide-item">
            <div class="image-layer lazy-image" style="background-image: url('{{ asset('frontend/images/main-slider/banner-2-3.jpg') }}');"></div>
            <div class="container">
                <div class="content-box text-center">
...
<!-- /.cta-two -->
<section class="about-two" style="background-image: url( {{ asset('frontend/images/backgrounds/event-bg-1-1.jpg') }}); padding-bottom: 340px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<section class="cta-three">
    <div class="container">
        <div class="inner-container wow fadeInUp" data-wow-duration="1500ms" style="background-image: url({{ asset('frontend/images/shapes/cta-bg-2-1.jpg') }});">
            <div class="cta-three__title">
                <h3><span>On View</span> <br> at Museum</h3>
            ...
            <div class="cta-three__content">
                <p>Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override
                    the digital divide with additiclick throughs Nanotechnology immersion.</p>
                <div class="cta-three__list-wrap">
                    ...
                    </ul><!-- /.list-unstyled cta-three__list -->
                    <ul class="list-unstyled cta-three__list">
